...
const Form = () => {
  ...
  const startCampaign = async (e) => {
    ...
    if (form.campaignTitle === "") {
      ...
      const contract = new ethers.Contract( // here we get instance of contract and conect with signer
      ...
      const campaignAmount = ethers.utils.parseEther(form.requiredAmount); // matic to weigh
      const campaignData = await contract.createCampaign( //here we call func of contract from frontend
        form.campaignTitle,
        campaignAmount,
        imageUrl,
        storyUrl,
