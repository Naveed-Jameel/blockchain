...
export default function Detail({ Data, DonationsData }) {
  ...
  useEffect(() => {
    const Request = async () => {
      ...
      const myDonations = contract.filters.donated(address); // here event give all donation of that given address
  ...
  return (
    <DetailWrapper>
      ...
      <RightContainer>
        ...
        <Donated>
          <LiveDonation>
            ...
            <Donation>
              <DonationData>0xabd...Edr4</DonationData>
              <DonationData>10 Matic</DonationData>
              <DonationData>3/12/22, 9:12:10 AM</DonationData>
            </Donation>
          </LiveDonation>
          <MyDonation>
      ...
      {/* <LeftContainer> uncomment this and del above
        <ImageSection>
          <Image
            layout="fill"
