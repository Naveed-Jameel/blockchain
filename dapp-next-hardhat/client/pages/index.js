...
export async function getStaticProps() {
  ...
  // event call createCampaign
  const getAllCampaigns = contract.filters.createCampaign();
  ...
  const getHealthCampaigns = contract.filters.createCampaign(
    null,
    null,
    null,
    null,
  ...
  const getEducationCampaigns = contract.filters.createCampaign(
    null,
    null,
    null,
    null,
  ...
  const getAnimalCampaigns = contract.filters.createCampaign(
    null,
    null,
    null,
    null,
